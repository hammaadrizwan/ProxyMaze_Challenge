...
const notifications = require('../services/notificationEngine');
...
router.post('/integrations', (req, res) => {
  ...
  notifications.dispatchFiredToNewIntegration(integration);

  // Spec says "Response: 200 OK or 201 Created" — use 201 for consistency
